      ...
      fetch(nextQuery)
        ...
        .then((data) => {
          ...
          var URL1 = 
            ...
            +city+"&lang=en_US&units=mi&appid=3c1946e328mshd9fa0bbc159f712p1befbbjsn7dcdf270cc76";
          ...
          .catch(err => {
            ...
            console.log(data);
            var lat = data.data.Typeahead_autocomplete.results[0].detailsV2.geocode.latitude;
            var lon = data.data.Typeahead_autocomplete.results[0].detailsV2.geocode.longitude;
            ...
            var URL2 = "https://travel-advisor.p.rapidapi.com/hotels/list-by-latlng?latitude="
            +lat+"&longitude="+lon+"&lang=en_US&limit=10&amenities=pool%2Cspa&rooms=1&currency=USD&checkin="
            +dateMonth+"%2F"+dateDay+"%2F"+dateYear+"&distance=10";
